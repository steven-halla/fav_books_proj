...
urlpatterns = [
    ...
    # the /login path maps to the log_in function which logs in the user.
    # if login fails, show error message on index page.
    # if login successful, redirect to /books
    path('login', views.log_in),
    # the /logout path maps to thg log_user_out function which logs out the user and redirects
    # redirects to index.
